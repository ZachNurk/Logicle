    ...
    (axiom: Axiom, sideOverride?: "left" | "right") => {
      ...
      switch (axiom.applyType) {
        ...
        case "2": {
          ...
          result = (applyFn as (premises: ProofNode, side: "left" | "right") => ProofNode)(prem, side);
          break;
        }
        case "3":
        ...
        case "5":
          ...
          break;
        case "6":
          result = (applyFn as (original: ProofNode, option: string) => ProofNode)(prem, axiom.applyOption ?? "");
          break;
        case "7":
