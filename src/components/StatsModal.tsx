...
const styles: Record<string, CSSProperties> = {
  ...
  twelveMonthGrid: {
    display: "grid",
    gridTemplateColumns: "repeat(6, clamp(140px, 15vw, 198px))",
    gap: "clamp(6px, 1vh, 12px) 14px",
    alignItems: "start",
    width: "max-content",
    minWidth: "100%",
    margin: "0 auto",
  ...
  miniMonthCard: {
    ...
    border: "1px solid #d8d4ce",
    borderRadius: "8px",
    padding: "clamp(5px, 0.8vh, 9px) 9px clamp(6px, 1vh, 11px)",
  ...
  miniMonthTitle: {
    ...
    border: "1px solid #d8d4ce",
    borderRadius: "6px",
    padding: "clamp(2px, 0.4vh, 4px) 8px",
    textAlign: "center",
  },
  miniMonthGrid: {
    display: "grid",
    gridTemplateColumns: "repeat(7, clamp(13px, 1.9vh, 22px))",
    gridAutoRows: "clamp(13px, 1.9vh, 22px)",
    gap: "clamp(2px, 0.4vh, 4px)",
    justifyContent: "center",
  },
  miniDayCell: {
    width: "clamp(13px, 1.9vh, 22px)",
    height: "clamp(13px, 1.9vh, 22px)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    borderRadius: "2px",
